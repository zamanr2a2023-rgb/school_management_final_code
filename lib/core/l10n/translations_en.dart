const Map<String, dynamic> translationsEn = {
  ...
  'auth': {
    ...
    'loginSubtitle': 'Sign in to continue to Garini',
    'createAccount': 'Create Account',
    'registerSubtitle': 'Join Garini',
    'iAmA': 'I am a:',
  ...
  'profile': {
    ...
    'achievementServiceSubtitle': 'Garini',
  ...
  'live': {
    ...
    'editLiveSession': 'Edit Live Session',
    'updateSession': 'Update Session',
    'sessionUpdated': 'Session updated successfully.',
    'updateSessionFailed': 'Could not update session. Try again.',
    'deleteSession': 'Delete Session',
    'sessionDeleted': 'Session deleted.',
    'deleteSessionFailed': 'Could not delete session.',
    'cannotEditCompletedSession': 'This session is completed and cannot be edited.',
    'cannotEditPastSession': 'This session has already passed and cannot be edited.',
    'cannotEditLiveSession': 'This session is live and cannot be edited.',
    'cannotEditSession': 'This session cannot be edited.',
    'activeSessions': 'Active Live Sessions',
    'activeNow': 'Active Now',
    'joinSession': 'Join Session',
    'joinOpensAt': 'Join opens {datetime} (5 minutes before start)',
    'joinNotYetAvailable': 'Join opens 5 minutes before the session starts',
    'readyToJoin': 'Ready to Join?',
    'readyToJoinHint': 'Tap the button below to open the meeting link',
    'openLinkFailed':
